...
const TOPRATEDMODS = ({ Productdata, addToCart, membertype, user }) => {
  const recentlyProducts = Productdata.filter(product => product.category === "TOP RATED MODS");
  ...
  return (
    <div className="font-[sans-serif] bg-white py-4">
      <div className="p-4 mx-auto lg:max-w-6xl max-w-xl md:max-w-full">
        <h2 className="text-xl font-extrabold text-gray-800 mb-12">TOP RATED MODS</h2>
